...
public class RobotHelloWorld extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robot_hello_world);
    }
    ...
    protected void onResume() {
        ...
        RobotProvider.getDefaultProvider().addConnectionListener(new ConnectionListener() {
            ...
            public void onConnected(Robot robot) {
                mRobot = (Sphero) robot;
                RobotHelloWorld.this.connected();
            }

            @Override
            public void onConnectionFailed(Robot sphero) {
                Log.d(TAG, "Connection Failed: " + sphero);
                Toast.makeText(RobotHelloWorld.this, "Sphero Connection Failed", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onDisconnected(Robot robot) {
                Log.d(TAG, "Disconnected: " + robot);
                Toast.makeText(RobotHelloWorld.this, "Sphero Disconnected", Toast.LENGTH_SHORT).show();
                RobotHelloWorld.this.stopBlink();
                mRobot = null;
            }
        });
        ...
        RobotProvider.getDefaultProvider().addDiscoveryListener(new DiscoveryListener() {
            ...
            public void onBluetoothDisabled() {
                ...
                Toast.makeText(RobotHelloWorld.this, "Bluetooth Disabled", Toast.LENGTH_LONG).show();
            }
        ...
        if(!success){
            Toast.makeText(RobotHelloWorld.this, "Unable To start Discovery!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void connected() {
        ...
        Toast.makeText(RobotHelloWorld.this, mRobot.getName() + " Connected", Toast.LENGTH_LONG).show();
        ...
        RobotHelloWorld.this.blink(false); // Blink the robot's LED
